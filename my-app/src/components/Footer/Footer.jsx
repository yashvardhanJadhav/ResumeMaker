...
function Footer() {
    return (
        <>
            <footer class="text-gray-600 body-font bg-[#1E2837] mt-12">
                <div class="container py-8 mx-auto flex items-center sm:flex-row flex-col">
                    <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                        <i className="fa-solid fa-2x fa-layer-group"></i>
                    ...
                    <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2020 Resume Builder —
                        <a href="https://yashvardhan-jadhav.netlify.app/" class="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@yashvardhanJadhav</a>
                    </p>
